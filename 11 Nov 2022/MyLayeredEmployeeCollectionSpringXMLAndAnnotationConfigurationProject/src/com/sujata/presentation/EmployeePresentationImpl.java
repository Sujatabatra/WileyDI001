...
public class EmployeePresentationImpl implements EmployeePresentation {
	...
	// Presentation will pass the request to service for processing and gives
	// response to client
	...
	public void performMenu(int choice) {
		...
		case 3:
			...
			if (employeeService.addEmployee(newEmployee))
				...
				System.out.println("Employee with id " + newEmployee.getEmpId()
						+ " already exist, so cannot add it as a new employee!");
